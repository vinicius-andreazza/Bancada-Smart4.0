...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.saveAll(List.of(
            ...
            Estoque.builder().posicao(20).cor(CorBloco.NENHUM.getValue()).build(),
            Estoque.builder().posicao(21).cor(CorBloco.NENHUM.getValue()).build(),
            Estoque.builder().posicao(22).cor(CorBloco.NENHUM.getValue()).build(),
            Estoque.builder().posicao(23).cor(CorBloco.NENHUM.getValue()).build(),
            Estoque.builder().posicao(24).cor(CorBloco.NENHUM.getValue()).build(),
            Estoque.builder().posicao(25).cor(CorBloco.NENHUM.getValue()).build(),
            Estoque.builder().posicao(26).cor(CorBloco.NENHUM.getValue()).build(),
